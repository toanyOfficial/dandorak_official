...
const faqItems = [
  ...
  ['보온 배달 되나요?', "네, 전국 어디에서 드시든 취식 시간에 가장 알맞게 드실 수 있도록 배송해드립니다. 단순히 '보온'이 아닙니다. 그냥 보온박스에 담아버리면 샐러드의 숨이 죽고 나물의 맛이 변하는 문제가 있습니다. 저희는 '수제 단체도시락 전문점'으로서, 저희만의 오래된 노하우를 통해 가장 맛있게 드실 수 있도록 잘 가져다 드리겠습니다."],
  ['보관해뒀다 먹어도 되나요?', "저희는 공장에서 조리된 완제품을 쓰지 않고 직접 원물을 가공해 사용하는 '수제 도시락'입니다. 그렇기 때문에 가급적 수령 직후, 아무리 늦어도 3~4시간 이내에는 취식하시길 권장드리며 특히 여름에는 반나절 이상은 보관하지 않는 것을 추천드립니다."],
  ...
  ['반찬이 매일 달라지나요? 커스텀 할 수 있나요?', '정해진 카테고리에 대해 세부 메뉴는 매일 달라집니다. 주문 규모에 따라 커스텀 가능합니다. 김치류(볶음김치)/나물(브로콜리,애호박)/계란류(스크램블,계란말이,계란찜,계란장)/새콤무침(미역오이무침,오이양배추무침,미나리무생채,도라지무침)/마른반찬(우엉조림,멸치볶음,견과류조림)/보조메인(비엔나,꽃맛살)'],
  ['글루텐프리, 슈가프리, 비건 등 커스텀은 어디까지 가능한가요?', '튀김류를 제외하고는 밀가루를 사용하지 않습니다. 콩고기와 슈거프리등의 커스텀이 가능하긴 하지만 주문 규모에 따라 적용 여부가 달라지기 때문에 별도 문의 부탁드립니다. 비건 도시락이 있지만, 조미료나 식자재 보관 방식까지 철저하게 비건으로 운영하지는 않고 있으니 참고 부탁드립니다.'],
];
